              ...
              <div class="carousel-inner px-md-0 pb-4">
                  	   	    ...
                  	   	    <div class="row">
			                       <div class="col-md-4 col-sm-4">
							    	 	 <div class="testimonial w-100 d-block text-center px-md-5">
							    	 	  	  <img src="<?php echo asset('templates-master/052-Jibok-Speech-Therapy-Clinic/images/testimonial-01.jpg'); ?>" alt="">
							       ...
							       <div class="col-md-4 col-sm-4">
							    	 	 <div class="testimonial w-100 d-block text-center px-md-5">
							    	 	  	   <img src="<?php echo asset('templates-master/052-Jibok-Speech-Therapy-Clinic/images/testimonial-02.jpg'); ?>" alt="">
							    	...
							    	<div class="col-md-4 col-sm-4">
							    	 	  <div class="testimonial w-100 d-block text-center px-md-5">
							    	 	  	   <img src="<?php echo asset('templates-master/052-Jibok-Speech-Therapy-Clinic/images/testimonial-03.jpg'); ?>" alt="">
                  ...
                  <div class="carousel-item">
                        <div class="col-md-12 col-sm-12">
			                       ...
			                       <div class="col-md-4 col-sm-4">
							    	 	 <div class="testimonial w-100 d-block text-center px-md-5">
							    	 	  	  <img src="<?php echo asset('templates-master/052-Jibok-Speech-Therapy-Clinic/images/testimonial-04.jpg'); ?>" alt="">
							       ...
							       <div class="col-md-4 col-sm-4">
							    	 	 <div class="testimonial w-100 d-block text-center px-md-5">
							    	 	  	   <img src="<?php echo asset('templates-master/052-Jibok-Speech-Therapy-Clinic/images/testimonial-05.jpg'); ?>" alt="">
							    	...
							    	<div class="col-md-4 col-sm-4">
							    	 	  <div class="testimonial w-100 d-block text-center px-md-5">
							    	 	  	   <img src="<?php echo asset('templates-master/052-Jibok-Speech-Therapy-Clinic/images/testimonial-06.jpg'); ?>" alt="">
                  ...
                  <div class="carousel-item">
                        <div class="col-md-12 col-sm-12">
			                       ...
			                       <div class="col-md-4 col-sm-4">
							    	 	 <div class="testimonial w-100 d-block text-center px-md-5">
							    	 	  	  <img src="<?php echo asset('templates-master/052-Jibok-Speech-Therapy-Clinic/images/testimonial-07.jpg'); ?>" alt="">
							       ...
							       <div class="col-md-4 col-sm-4">
							    	 	 <div class="testimonial w-100 d-block text-center px-md-5">
							    	 	  	   <img src="<?php echo asset('templates-master/052-Jibok-Speech-Therapy-Clinic/images/testimonial-08.jpg'); ?>" alt="">
							    	...
							    	<div class="col-md-4 col-sm-4">
							    	 	  <div class="testimonial w-100 d-block text-center px-md-5">
							    	 	  	   <img src="<?php echo asset('templates-master/052-Jibok-Speech-Therapy-Clinic/images/testimonial-09.jpg'); ?>" alt="">
