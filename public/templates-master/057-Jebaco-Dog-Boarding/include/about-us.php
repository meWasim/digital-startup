<div class="container py-3">
	 ...
	 <div class="row">
	 	  <div class="col-md-6 col-sm-6 story-bg">
	 	  	   ...
	 	  	   <p class="d-block pb-md-3">We set up My Site in 2000 to provide an incredible experience for animals and owners. From small beginnings, we’ve added a whole range of services, making us the premier Dog Boarding in San Francisco. While we’re proud of our fun and easygoing attitude, our commitment to the safety and security of your pet guides everything we do.</p>
	 	  ...
	 	  <div class="col-md-6 col-sm-6 pr-md-0">
	 	  	   <img src="http://127.0.0.1:8000/templates-master/057-Jebaco-Dog-Boarding/images/story.jpg" class="img-fluid" alt="">
	 	  </div>
	 </div>
</div>