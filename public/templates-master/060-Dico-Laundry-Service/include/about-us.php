<div class="container py-3">
	 ...
	 <div class="row">
	 	  <div class="col-md-6 col-sm-6 story-bg">
	 	  	   ...
	 	  	   <p class="d-block pb-md-3">Over the years, we’ve learned that great service begins and ends with experienced and friendly professionals, which explains our rigorous hiring process. We believe that our team is the best in the business, and have complete and total confidence in every person providing our services.<br><br>My Site finishes each project on schedule and with the highest level of quality. With a focus on personalized service, competitive rates and customer satisfaction, we’re always striving to meet and exceed expectations.</p>
	 	  ...
	 	  <div class="col-md-6 col-sm-6 pr-md-0">
	 	  	   <img src="http://127.0.0.1:8000/templates-master/060-Dico-Laundry-Service/images/story-01.jpg" class="img-fluid" alt="">
	 	  </div>
	 </div>
</div>