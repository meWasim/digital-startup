...
<nav class="navbar navbar-inverse fixed-top" id="sidebar-wrapper" role="navigation">
    <ul class="nav flex-column sidebar-nav">
        ...
        <!-- Regular Items -->
        <li class="nav-item">
            <a href="logo-design.php" class="nav-link <?php echo e(request()->routeIs('logo-design') ? 'active' : ''); ?>">
                <i class="fa fa-paint-brush mr-2"></i>Logo Design
            </a>
        </li>
        <li class="nav-item">
            <a href="graphic-design.php" class="nav-link <?php echo e(request()->routeIs('graphic-design') ? 'active' : ''); ?>">
                <i class="fa fa-picture-o mr-2"></i>Graphic Design
            </a>
        </li>
        <li class="nav-item">
            <a href="website-design.php" class="nav-link <?php echo e(request()->routeIs('website-design') ? 'active' : ''); ?>">
                <i class="fa fa-desktop mr-2"></i>Website Design
            </a>
        </li>
        <li class="nav-item">
            <a href="brochure-design.php" class="nav-link <?php echo e(request()->routeIs('brochure-design') ? 'active' : ''); ?>">
        ...
        <li class="nav-item">
            <a href="crm-software-development.php"
                class="nav-link <?php echo e(request()->routeIs('crm-software-development') ? 'active' : ''); ?>">
        ...
        <!-- Management Section -->
        <li
            class="nav-item <?php echo e(request()->routeIs(['roles.*', 'permissions.*', 'admin.templates.*', 'blogs.*']) ? 'management-active' : ''); ?>">
            <a class="nav-link <?php echo e(request()->routeIs(['roles.*', 'permissions.*', 'admin.templates.*', 'blogs.*']) ? '' : 'collapsed'); ?>"
                data-bs-toggle="collapse" href="#managementSubmenu" role="button"
                aria-expanded="<?php echo e(request()->routeIs(['roles.*', 'permissions.*', 'admin.templates.*', 'blogs.*']) ? 'true' : 'false'); ?>"
                aria-controls="managementSubmenu">
                <i class="fa fa-cogs mr-2"></i>Management
            </a>
            <div class="collapse <?php echo e(request()->routeIs(['roles.*', 'permissions.*', 'admin.templates.*', 'blogs.*']) ? 'show' : ''); ?>"
