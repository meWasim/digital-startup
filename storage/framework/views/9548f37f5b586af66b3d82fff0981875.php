<?php $__env->startSection('title', 'Users - Digital Startups'); ?>
                                ...
                                <td>
                                    <div class="d-flex justify-content-start">
                                        ...
                                        <form action="<?php echo e(route('users.destroy', $user->id)); ?>" method="POST"
                                            style="display:inline-block;" id="delete-form-<?php echo e($user->id); ?>">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Wasim Ansari\OneDrive\Desktop\freework\digitalStartups\resources\views/users/index.blade.php ENDPATH**/ ?>